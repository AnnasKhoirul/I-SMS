  ...
  <!-- Section: fitur -->
      <div class="col-md-4">
    <a href="#" data-target="#ModalAdd" data-toggle="modal" class="btn btn-primary" style="margin-bottom: 20px;margin-left: 35px">Tambah Data</a>
        ...
        <div class="col-lg-8 col-lg-offset-2">
          <div class="animatedParent">
            ...
            <div class="section-heading text-center">
              ...
              <?php include('pages/fitur/ubah/ubah_judul_fit.php'); ?>
            </div>
            <?php } ?>
          </div>
        </div>
            ...
            <div class="">
              <div class="service-box" style="width: 100%; height: 320px">
                ...
                <div class="service-desc">
                  ...
                  <?php include('pages/fitur/edit&delete_fitur.php'); ?>
                </div>
              </div>
            </div>
          </div>
...
if (isset($_POST['simpan'])) {
  ...
  $deskripsi=$_POST['deskripsi'];
    ...
    $sql = $koneksi->query("INSERT INTO fitur (icon, nama, deskripsi)VALUES('$icon','$nama','$deskripsi')");

    if ($sql) {
      ?>
        <script type="text/javascript">
          alert ("Data Berhasil Disimpan");
          window.location.href="?page=fitur2";
        </script>
