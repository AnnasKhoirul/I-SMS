        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="pages/fitur/delete.php?id=<?php echo $data['id'];?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
    ...
    <div class="modal fade" id="edit<?php echo $data['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
				<?php
					$edit=mysqli_query($koneksi,"select * from fitur where id='".$data['id']."'");
...
if (isset($_POST['ubah'])) {
  $id 	    =$_POST['id'];
  	...
  	$edit = $koneksi->query("UPDATE fitur SET icon = '$_POST[icon]',nama = '$_POST[nama]',deskripsi = '$_POST[deskripsi]'  WHERE id = '$id'");
