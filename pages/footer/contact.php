            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><i class="fa <?php echo $data['icon'];?> mr-3"></i></td>
                  ...
                  <td>
                    ...
                    <?php include('pages/footer/ubah/ubah_contact.php'); ?>
                  </td>
                </tr>
                  <?php } ?>
              </table>
...
if (isset($_POST['simpan'])) {
  ...
  $keterangan =$_POST['keterangan'];
    ...
    $sql = $koneksi->query("INSERT INTO contact (icon, keterangan)VALUES('$icon','$keterangan')");
