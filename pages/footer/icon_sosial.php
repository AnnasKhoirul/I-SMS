      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
             <h1 class="box-title">Icon Sosial </h1>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
                  ...
                  <td><i class="fa <?php echo $data['icon'];?>"></i></td>
                  ...
                  <td>
                    ...
                    <?php include('pages/footer/ubah/ubah_iconsos.php'); ?>
                  </td>
                </tr>
                  <?php } ?>
              </table>
...
<div class="modal-dialog">
    ...
    <option value='fa-youtube-square'>&#xf166; fa-youtube-square</option>          
                ...
                <div class="form-group" style="padding-bottom: 20px;">
                  ...
                  <input type="text" name="nama"  class="form-control" placeholder="Nama Icon" required/>
                </div>
...
if (isset($_POST['simpan'])) {
  ...
  $nama     =$_POST['nama'];
    ...
    $sql = $koneksi->query("INSERT INTO icon_sosialmed (icon, nama)VALUES('$icon','$nama')");
