        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="pages/footer/ubah/delete_iconsos.php?id=<?php echo $data['id'];?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
...
<!-- Edit -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
                <?php
                    $edit=mysqli_query($koneksi,"select * from icon_sosialmed where id='".$data['id']."'");
                ...
                <div class="container-fluid">
                    <form action="" enctype="multipart/form-data" method="POST">
                        <div class="form-group"  style="padding-bottom: 20px;">
                            ...
                            <span class="fa <?php echo $data['icon'];?> mr-3"></span>
                            </div>
                        </div>
    ...
    <option value='<?php echo $data['icon'];?>'><?php echo $data['icon'];?></option>
    ...
    <option value='fa-youtube-square'>&#xf166; fa-youtube-square</option>          
                    ...
                    <div class="form-group" style="padding-bottom: 20px;">
                        <label for="Modal Name">Nama Icon</label>
...
if (isset($_POST['ubah'])) {
  ...
  $nama   =$_POST['nama'];
    ...
    $sql = $koneksi->query("UPDATE icon_sosialmed SET icon='$icon', nama='$nama' WHERE id = '$id'");

    if ($sql) {
      ?>
        <script type="text/javascript">
          alert ("Data Berhasil Diubah");
          window.location.href="?page=icon_sosial";
        </script>
