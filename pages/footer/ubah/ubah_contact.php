        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="pages/footer/ubah/delete_contact.php?id=<?php echo $data['id'];?>" class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Delete</a>
                </div>
...
<!-- Edit -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
                <?php
                    $edit=mysqli_query($koneksi,"select * from contact where id='".$data['id']."'");
...
if (isset($_POST['ubah'])) {
  ...
  $keterangan   =$_POST['keterangan'];
    ...
    $sql = $koneksi->query("UPDATE contact SET icon='$icon', keterangan='$keterangan' WHERE id = '$id'");
